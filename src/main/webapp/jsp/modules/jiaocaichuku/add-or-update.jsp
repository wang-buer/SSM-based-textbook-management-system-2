		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑教材出库</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑教材出库</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">教材出库信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>出库说明</label>
										<input name="chukushuoming" id="chukushuoming" name="chukushuoming" class="form-control" placeholder="出库说明">
									</div>
									<div class="form-group col-md-6">
										<label>出库时间</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jiaocaichuku/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("jiaocaichuku/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jiaocaichuku/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jiaocaichuku/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#chukushijian-input").val(getCurDateTime());
		...
		function dataBind(){
			...
			$("#chukushuoming").val(ruleForm.chukushuoming);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.chukushuoming != null && res.data.chukushuoming != ''){

						$("#chukushuoming").val(res.data.chukushuoming);
						$("#chukushuoming").attr('readonly','readonly');
					}
