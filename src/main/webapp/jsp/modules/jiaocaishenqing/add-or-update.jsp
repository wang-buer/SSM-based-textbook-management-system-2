		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑教材申请</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>教材申请管理</span></li>
								<li class="breadcrumb-item active"><span>编辑教材申请</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">教材申请信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>申请数量</label>
										<input name="shenqingshuliang" id="shenqingshuliang" name="shenqingshuliang" class="form-control" placeholder="申请数量">
									</div>
									<div class="form-group col-md-6">
										<label>申请说明</label>
										<input name="shenqingshuoming" id="shenqingshuoming" name="shenqingshuoming" class="form-control" placeholder="申请说明">
									</div>
									<div class="form-group col-md-6">
										<label>教师姓名</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jiaocaishenqing/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("jiaocaishenqing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jiaocaishenqing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jiaocaishenqing/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("jiaocaishenqing"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#shenqingshuoming").val(ruleForm.shenqingshuoming);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shenqingshuliang != null && res.data.shenqingshuliang != ''){
						...
						$("#shenqingshuliang").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.shenqingshuoming != null && res.data.shenqingshuoming != ''){

						$("#shenqingshuoming").val(res.data.shenqingshuoming);
						$("#shenqingshuoming").attr('readonly','readonly');
					}
