...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>邮箱地址</label>
										<input name="youxiangdizhi"  id="youxiangdizhi" name="youxiangdizhi" class="form-control" placeholder="邮箱地址">
									</div>
									<div class="form-group col-md-6">
										<label>职位</label>
										<input name="zhiwei" readonly id="zhiwei" name="zhiwei" class="form-control" placeholder="职位">
									</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#youxiangdizhi").val(ruleForm.youxiangdizhi);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.youxiangdizhi != null && res.data.youxiangdizhi != ''){

					$("#youxiangdizhi").val(res.data.youxiangdizhi);
					}
