...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>教材编号</label>
										<input name="jiaocaibianhao" id="jiaocaibianhao" name="jiaocaibianhao" class="form-control" placeholder="教材编号">
									</div>
									<div class="form-group col-md-6">
										<label>教材名称</label>
									...
									<div class="form-group col-md-6">
										<label>教材分类</label>
										<input name="jiaocaifenlei" id="jiaocaifenlei" name="jiaocaifenlei" class="form-control" placeholder="教材分类">
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
									...
									<div class="form-group col-md-6">
										<label>版次</label>
										<input name="banci" id="banci" name="banci" class="form-control" placeholder="版次">
									</div>
									<div class="form-group col-md-6">
										<label>出版时间</label>
										<div id="chubanshijianDate" class="input-append date form_datetime">
											<input id="chubanshijian-input" name="chubanshijian" size="15" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>入库来源</label>
										<input name="rukulaiyuan" id="rukulaiyuan" name="rukulaiyuan" class="form-control" placeholder="入库来源">
									</div>
									<div class="form-group col-md-6">
										<label>入库时间</label>
	...
	<script>
		...
		function dateTimePick(){
			...
			$("#chubanshijianDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jiaocaifenlei != null && res.data.jiaocaifenlei != ''){
						...
						$("#jiaocaifenlei").val(res.data.jiaocaifenlei);
						$("#jiaocaifenlei").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.banci != null && res.data.banci != ''){

						$("#banci").val(res.data.banci);
						$("#banci").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.chubanshijian != null && res.data.chubanshijian != ''){

						$("#chubanshijian-input").val(res.data.chubanshijian);
						$('#chubanshijianFileName').val(res.data.chubanshijian)
					}
					...
					if(res.data != null && res.data != '' && res.data.rukulaiyuan != null && res.data.rukulaiyuan != ''){

						$("#rukulaiyuan").val(res.data.rukulaiyuan);
						$("#rukulaiyuan").attr('readonly','readonly');
					}
